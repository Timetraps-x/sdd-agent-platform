...
- 不实现 Phase 6 agent/skill runtime 或 Phase 7 code graph。
...
- Phase 6 可引用 Phase 5.7 regression gate，作为 agent/skill runtime harness 的质量基线；Phase 7 可继续消费这些 harness metadata 进入 code graph。
