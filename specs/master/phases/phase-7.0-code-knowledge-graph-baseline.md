...
Phase 7.0 是原 Phase 6.0 Code Knowledge Graph Baseline 的顺延版本。它在 Phase 6 Agent / Skill / Team Runtime Harness、Phase 6.1 Resident Agent Worker Runtime、Phase 6.2 RC Stabilization、Phase 6.3 Declarative Agent/Skill Capability Runtime、Phase 6.4 Spec Partition Entry、Phase 6.5 Parallel Branch Run Isolation、Phase 6.6 Documentation Information Architecture、Phase 6.7 Token Budget and Output Dedup Runtime 和 Phase 6.8 Project Document Language Runtime 完成后再启动，消费 Phase 5 的 harness metadata、Phase 5.10 的 document-chain evidence、Phase 6 形成的 agent / skill / team / host adapter execution records、Phase 6.2 的 release-candidate validation evidence、Phase 6.3 的 merged runtime registry evidence、Phase 6.4 的 partition/revision evidence、Phase 6.5 的 partition-aware run isolation evidence、Phase 6.6 的 documentation IA evidence、Phase 6.7 的 output dedup evidence，以及 Phase 6.8 的 document language evidence。
...
- 消费 Phase 6.2 的 RC validation evidence、Phase 6.3 的 merged runtime registry evidence、Phase 6.4 的 partition/revision evidence、Phase 6.5 的 partition-aware run isolation evidence、Phase 6.6 的 documentation IA evidence、Phase 6.7 的 output dedup evidence 和 Phase 6.8 的 document language evidence，确保 graph baseline 基于稳定且可扩展的 agent/skill/source registry、spec namespace、run provenance、文档分类边界、runtime 输出边界和文档语言边界启动。
...
- 能消费 Phase 6.2 的 RC validation evidence、Phase 6.3 的 merged runtime registry evidence、Phase 6.4 的 partition/revision evidence、Phase 6.5 的 partition-aware run isolation evidence、Phase 6.6 的 documentation IA evidence、Phase 6.7 的 output dedup evidence 和 Phase 6.8 的 document language evidence，确认 graph baseline 启动时 core/CLI/test/package 边界、agent/skill/source 扩展机制、spec namespace、run provenance、文档分类边界、runtime 输出边界和文档语言边界已通过验证。
