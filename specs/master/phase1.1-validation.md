...
| Phase 5 graph metadata | Phase 5 可消费 metadata 来源明确 | pass | `docs/architecture/sdd-agent-platform-architecture.md` §18 明确 task metadata、events、artifact result、validation mapping、decision record、gap 等 graph-ready metadata。 |
